...
interface MetricRecorder {
  ...
  /**
   * Whether this recorder actually records anything. Callers use this to skip instrumentation work
   * altogether when telemetry is disabled.
   */
  boolean isEnabled();
